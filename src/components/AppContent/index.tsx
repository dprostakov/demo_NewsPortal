...
import NewsDetail, {routeMain as routeNewsDetailPage} from "pages/NewsDetail";
    ...
    <div className="mainWrapper">
      ...
      <main>
        <Switch>
          ...
          <Route exact path={routeNewsDetailPage()} component={NewsDetail}/>
          <Route exact path={routeContacts()} component={Contacts}/>
          <Redirect
            to={{pathname: routeMainPage()
            }}
          />
        </Switch>
      </main>
